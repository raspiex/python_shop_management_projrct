...
class FirstPage:
    ...
    def __init__(self, dashboard_window):
        ...
        # heading = Label(homepage, text='THE COFFEE HOUSE', bg='white', fg='#ff6c38', font=("yu gothic ui", 19, "bold"))
        # heading.place(x=770, y=90)

        heading2 = Label(homepage, text='Trending', bg='white', fg='#ff6c38', font=("", 19, "bold"))
        heading2.place(x=150, y=95)

        # Coffee Image
        coffeeImage = Image.open('images//menu-6.png')
        photo = ImageTk.PhotoImage(coffeeImage)
        coffeeImg = Label(homepage, image=photo, bg='white')
        ...
        coffeeImg2 = Label(homepage, image=photo, bg='white')
        ...
        coffeeImg3 = Label(homepage, image=photo, bg='white')
        ...
        coffeeImg4 = Label(homepage, image=photo, bg='white')
        ...
        coffeeImg5 = Label(homepage, image=photo, bg='white')
        ...
        coffeeImg6 = Label(homepage, image=photo, bg='white')
        coffeeImg6.image = photo
        coffeeImg6.place(x=270, y=275)

        heading3 = Label(homepage, text='Cappuccino', bg='white', fg='#ff6c38', font=("", 9, "bold"))
        heading3.place(x=55, y=245)

        heading4 = Label(homepage, text='Mocha', bg='white', fg='#ff6c38', font=("", 9, "bold"))
        heading4.place(x=182, y=245)

        heading5 = Label(homepage, text='Piccolo Latte', bg='white', fg='#ff6c38', font=("", 9, "bold"))
        heading5.place(x=282, y=245)

        heading6 = Label(homepage, text="Cafe' Latte", bg='white', fg='#ff6c38', font=("", 9, "bold"))
        heading6.place(x=56, y=370)

        heading7 = Label(homepage, text='Espresso', bg='white', fg='#ff6c38', font=("", 9, "bold"))
        heading7.place(x=170, y=370)

        heading8 = Label(homepage, text='Black Coffee with milk', bg='white', fg='#ff6c38', font=("", 8, "bold"))
