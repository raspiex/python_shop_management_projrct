...
class SecondPage:
    ...
    def getbill1(total1):
        ...
        temp2=int(SecondPage.showtotal())
        temp2=temp2+temp
        con = sqlite3.connect('A_database.db')
        cur = con.cursor()
        cur.execute("UPDATE total_profit SET pr_month = ?, pr_monthly = ?, pr_profit = ?", ('November', temp2, temp2))
        con.commit()
        # print("updated 5")
        return 
    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                logo = Label(product_page, image=photo, bg='#ffffff')
                logo.image = photo
                logo.place(x=980, y=33)
                ...
                adm = Label(product_page, image=photo, bg='#ffffff')
                adm.image = photo
                ...
                # ========== HOME BUTTON =======
                home_button = Button(product_page, text='Home', bg='#ffffff', font=("", 13, "bold"), bd=0, fg='#7a7a7a',
                                     cursor='hand2', activebackground='#ffffff', activeforeground='#7a7a7a',
                                     command=lambda: home())
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                self.genCashier_name = Label(self.coverFrame6, text='Customer Name', font=("yu gothic ui", 10, "bold"),
                                             bg='#ffffff', fg='#000000')
                ...
                self.genCom_number = Label(self.coverFrame6, text='Customer Number', font=("yu gothic ui", 10, "bold"),
                                          bg='#ffffff', fg='#000000')
                ...
                self.company_number.configure(text="Customer Number")
                ...
                self.cashier_name.configure(text="Customer Fullname")
                ...
                if self.state == 1:
                    ...
                    if(cust_name.get()==""):
                        ...
                        if strr.find('Total')==-1:
                            ...
                            s3 = "\n\t" + ("-"*70) + "\n\t     FOR COMPLAINTS CALL : 9075733381 "
